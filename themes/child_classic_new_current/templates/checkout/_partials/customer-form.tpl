...
{block "form_buttons"}
   {assign var='displayCustomerLoginFormAfter' value={hook h='displayCustomerLoginFormAfter'} }
   {if $displayCustomerLoginFormAfter}
        <div style="margin: 20px 0px 10px 0px !important;">
